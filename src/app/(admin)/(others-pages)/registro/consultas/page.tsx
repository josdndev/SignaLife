...
export default function ConsultasPage() {
  const [formData, setFormData] = useState({
    ...
    prediagnostico: "",
    evaluacion_triaje: "Verde", // Por defecto para consultas
  });
    ...
    try {
      ...
      const visitaResponse = await fetch(`${API_URL}/visitas/`, {
        ...
        body: JSON.stringify({
          ...
          prediagnostico: formData.prediagnostico || "Pendiente de evaluación",
      ...
      setSuccess("Paciente registrado exitosamente para consulta");
      // Limpiar formulario
      setFormData({
        nombre: "",
        cedula: "",
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Registro de Consultas" />
      <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12">
        <div className="mx-auto w-full max-w-[630px]">
          <h3 className="mb-4 text-center font-semibold text-gray-800 text-theme-xl dark:text-white/90 sm:text-2xl">
            Formulario de Registro para Consultas
          </h3>
          <p className="mb-8 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-base">
            Complete los datos del paciente para agendar una consulta
          </p>
