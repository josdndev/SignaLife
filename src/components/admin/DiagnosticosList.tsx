    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder={t('diagnosticos.searchPlaceholder')}
            value={searchTerm}
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {filteredDiagnosticos.map((diagnostico, index) => (
              <tr key={diagnostico.id} className={`hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors duration-200 ${index % 2 === 0 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-700'}`}>
      ...
      {filteredDiagnosticos.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">{t('diagnosticos.noDiagnosticos')}</h3>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            {searchTerm ? t('diagnosticos.noDiagnosticosMessage') : t('diagnosticos.noDiagnosticosMessage')}
          </p>
        </div>
      )}
    </div>
